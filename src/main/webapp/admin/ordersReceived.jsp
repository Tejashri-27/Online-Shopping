...
<table id="customers">
   ...
   try{
	   ...
	   ResultSet rs=st.executeQuery("select * from card inner join product where card.product_id=product.id and card.orderdate is not NULL and card.status='processing'");
	   while(rs.next()){   
   %>     
